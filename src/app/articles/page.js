...
export default function AudioPage() {
  ...
  <div className="h-full min-h-screen bg-blue-100 p-4 flex flex-col">
      ...
      <div className="flex justify-center gap-4 flex-wrap">
        {languages.map((lang) => (
          <button
            key={lang}
            onClick={() => setSelectedLang(lang)}
            className={`px-5 py-2 rounded-xl shadow-md cursor-pointer transition ${selectedLang === lang
              ? "bg-blue-800 text-white"
              : "bg-white text-gray-700 hover:bg-gray-200"
              }`}
          >
    ...
    {/* MAIN LAYOUT (scrollable content below header) */}
  ...
  return (
    <div className="h-full min-h-screen bg-blue-100 p-4 flex flex-col">
      ...
      <div className="flex flex-col md:flex-row gap-6 flex-1 min-h-0">
        ...
        {/* RIGHT: Selected article (no scrolling) */}
        {/* RIGHT: Selected article */}
        <div className="w-full md:w-2/3 flex flex-col bg-white shadow-xl rounded-2xl p-6 order-1 md:order-2">
          {/* ... selected article code ... */}
          ...
          {selectedArticle ? (
            <>
              ...
              {/* Title */}
              <h2 className="text-x1 font-semibold text-center mb-6">
              ...
              <div className="w-full flex justify-center">
                <audio
                  ...
                  src={`${backendUrl}/audio/27/${selectedLang}/${selectedArticle.audio ?? selectedArticle.audioFile ?? selectedArticle.file ?? ""}`}
                >
                  Your browser does not support the audio element.
                </audio>
              </div>
