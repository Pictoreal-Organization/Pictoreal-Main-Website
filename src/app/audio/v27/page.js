...
function AudioIndex() {
  ...
  return (
    <div className="min-h-screen bg-mist-texture">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className="absolute top-40 -right-40 w-80 h-80  rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-pulse animation-delay-2000"></div>
        <div className="absolute -bottom-40 left-40 w-80 h-80 rounded-full mix-blend-multiply filter blur-xl opacity-10 animate-pulse animation-delay-4000"></div>
      </div>
      ...
      <div className="absolute inset-0">
        {[...Array(20)].map((_, i) => (
          <div
            key={i}
            className="absolute w-2 h-2 bg-gray-300 rounded-full opacity-20 animate-float"
            style={{
      ...
      <div className="relative z-10 max-w-4xl mx-auto p-6">
        ...
        <div className="text-center mb-16 pt-12">
          <div className="animate-fadeInUp">
            <h1 className="text-6xl font-bold text-firefly mb-6 bg-gradient-to-r from-firefly via-blue-100 to-orange-100 bg-clip-text text-transparent">
              🎵 Audio Library
            </h1>
            <div className="w-24 h-1 bg-gradient-to-r from-indigo-400 via-sky-300 to-violet-300 mx-auto rounded-full mb-6 animate-expandWidth"> 
              
            </div>
            <link href="https://fonts.googleapis.com/css2?family=Prata&display=swap" rel="stylesheet" />

            <p className="font-['Prata'] text-xl text-firefly opacity-90 animate-fadeInUp animation-delay-500">
              Choose your language to enjoy immersive audio content and articles.
            </p>
          </div>
        </div>
          ...
          {languages.map((lang, index) => (
            ...
            >
              ...
              `}>
                ...
                {/* Content */}
                <div className="relative z-10 text-center text-firefly">
                  <div className={`
                  ...
                  <h2 className="text-2xl font-bold mb-2 transform transition-all duration-300 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-white group-hover:to-blue-900 group-hover:bg-clip-text">
                    {lang.name}
                  </h2>
                  
                  {/* Animated Underline */}
                  <div className="w-0 h-0.5 bg-gradient-to-r from-indigo-400 via-sky-300 to-violet-300 mx-auto transition-all duration-500 group-hover:w-full" />
                  ...
                  `}>
                    <span className="text-sm text-firefly">Click to explore →</span>
                  </div>
                </div>
