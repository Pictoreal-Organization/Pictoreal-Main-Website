        ...
        <div className="relative bg-firefly w-full md:w-4/5 max-w-[1200px] p-2 md:p-5 border-[10px] border-lynch mx-auto">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="font-poppins text-[20px] text-lynch pl-8 pt-8 text-center">
              <span className="text-bali">Author: </span>Student Life Chronicles
            </div>
          </div>
          ...
          <div className="text-justify font-poppins text-[17px] text-bali p-8 pl-[10px] pr-[10px] pt-[30px] pb-[30px]">
            <article>
              ...
              <div className="blog-content-image border-[5px] border-lynch w-full md:w-1/2 mx-auto mb-5">
                <img
              ...
              <h2 className="font-raleway font-medium text-3xl text-bali mb-3 mt-8">
              ...
              <div className="blog-content-image border-[5px] border-lynch w-full md:w-1/3 mx-auto mb-5">
                <img
                  className="w-full h-auto"
