  ...
  return (
    <>
      <div className="flex flex-col p-2 md:p-10 pt-10">
        <div className="relative bg-firefly w-full md:w-4/5 max-w-[1200px] py-10 md:p-5 border-[10px] border-bali mx-auto">
          <div className="font-raleway px-2 font-bold pt-10 text-2xl md:text-5xl text-bali text-center">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="font-poppins text-[20px] text-bali md:pl-8 pt-8">
              <span className="text-bali">Author: </span>Ayan Pathan
            </div>
          </div>
          ...
          <div className="text-justify font-poppins text-[17px] text-bali p-8 pl-[10px] pr-[10px] pt-[30px] pb-[30px]">
            <article className="p-2 lg:p-5">
              ...
              <p>
                ...
                है, न जाने क्यों ।{" "}
                <strong className="text-lg text-bali">
                ...
                <strong className="text-lg text-bali">"और मियाँ, क्या चल रहा?"</strong>
              </p>
              ...
              <p>
                ...
                आदमी ने जवाब दिया -
                <br />
                <strong className="text-lg text-bali">हाओ!</strong>
                <br />
                टीचर को समझ न आया कि यह{" "}
                <strong className="text-lg text-bali">हाओ</strong> क्या चीज़ होती है ।
                <br />
                टीचर ने दूसरे शख्स से पूछा ।
                <br />
                फिरसे जवाब मिला - <strong className="text-lg text-bali">हाओ!</strong>
                <br />
                जब टीचर ने एक और बंदे से पूछा तो उसने कुछ अलग जवाब दिया |
                <br />
                उसने कहा - <strong className="text-lg text-bali">जी हाँ!</strong>
                <br />
                <br />
                ...
                <strong className="text-lg text-bali">हम रोज़ इस्तेमाल करते है</strong> और
                हमें पता भी नहीं ! ख़ैर, जो असल सवाल ज़ेहन में आता है कि दक्खनी
                बाकी भाषाओं से इतना मेल क्यों खाती है । इसका जवाब देकर मै शायद
                आपके सारे सवालों का जवाब दे पाऊँगा । दक्खनी बड़ी पुरानी भाषा है
                । तजुर्बा रखने वाले लोगों का कहना है कि दक्खनी भाषा{" "}
                <strong className="text-lg text-bali">
              ...
              <p>
                ...
                <p className="text-lg text-bali">
                  सच कहूँ तो यह भाषा कभी{" "}
                  <strong className="text-lg text-bali">लिखी जाती थी !</strong> बहमनी
                  साम्राज्य के दौर में लगभग{" "}
                  <strong className="text-lg text-bali">सन १५८०</strong>, या उससे भी पहले
                  ! दक्खनी बहमनी साम्राज्य की अधिकारिक भाषा हुआ करती थी । मुझे
                  यह भी पता चला कि{" "}
                  <strong className="text-lg text-bali">हैदराबाद के नवाब</strong> मोहम्मद
                  क़ुली क़ुतुब शाह ने दक्खनी में बहुत-सी कविताएँ भी लिखी है ।
                  फिर दक्खनी का कागज़ पर{" "}
                  <strong className="text-lg text-bali">
              ...
              <p>
                ...
                <strong className="text-lg text-balik">
              ...
              <p>
                ...
                बताना चाहता हूँ{" "}
                <strong className="text-lg text-bali">'बैगन का मसला' !</strong> बैगन आपके
                लिए सिर्फ़ एक सब्ज़ी होगी, पर मुझ जैसे कई लोगों के लिए बैगन एक{" "}
                <strong className="text-lg text-bali">सब्ज़ी से कहीं बढ़कर है !</strong>{" "}
                ...
                <strong className="text-lg text-bali">विशेषण</strong> बन जाती है । बैगन
                ज़्यादातर एक <strong className="text-lg text-bali">स्लैंग शब्द</strong>{" "}
                जैसे या फिर कोई{" "}
                <strong className="text-lg text-bali">ख़राब या गलत हुई चीज़</strong> को
                दर्शाने के लिए इस्तेमाल किया जाता है । मै आपको एक चित्र के सहारे
                समझाता हूँ ।
              </p>
              {/* </div> */}

              <div className="flex justify-center items-center my-4 border-5 border-lynch md:w-5/12 mx-auto">
                  <Image
              ...
              <br></br>
              <p>
                <strong className="text-lg text-bali">दक्खनी और मराठी</strong> का रिश्ता
                भी हिंदी या उर्दू की तरह ही बहुत खास है । जैसा मैंने पहले बताया
                था, दक्खनी मराठी से भी बनी है, तो हमें इन दोनों भाषाओं में
                बहुत-सी समानताएँ नज़र आती है । मुझे याद है कुछ शब्द जैसे
                'फ़ज़ीती' हमें दोनों भाषाओं में इस्तेमाल होते हुए नज़र आते है ।
                इन दोनों भाषाओं के{" "}
                <strong className="text-lg text-bali">‘फ़ोनेटिक पैटर्न’</strong> में भी कई
                समानताएँ है, जिसके कारण इन भाषाओं पर{" "}
                <strong className="text-lg text-bali">‘द्रविड़ियन इन्फ्लुएंस’</strong>{" "}
                देखने को मिलता है ।
              </p>
              <br />
              <p>
                ...
                <strong className="text-lg text-bali">‘दरवाजा’</strong> (दरवाज़ा) और{" "}
                <strong className="text-lg text-bali">‘महमान’</strong> (मेहमान) शामिल है ।
                इसके अतिरिक्त, दोनों भाषाओं में रोज-मर्रा की चीजों के लिए समान
                शब्द है : <strong className="text-lg text-bali">‘किताब’</strong> (पुस्तक)
                दक्खनी और उर्दू में है, जब कि कन्नड़ में इसे{" "}
                <strong className="text-lg text-bali">‘पुस्तका’</strong> कहा जाता है ।
                दखनी में <strong className="text-lg text-bali">‘रोटी’</strong>, उर्दू में
                भी ‘रोटी’ ही है, जबकि कन्नड़ में इसे{" "}
                <strong className="text-lg text-bali">‘रोट्टी’</strong> कहा जाता है ।
                वाक्य रचनाएँ और व्याकरण में भी समानताएँ दिखाई देती है, अक्सर ये
                वाक्य संरचनाएँ Subject-Object-Verb (SOV) क्रम का पालन करती है ।
              </p>
              ...
              <p className="mt-6">
                ...
                छोड़ो कल की बातें, कल कि बाते <strong className="text-lg text-bali">बैगन</strong> की,
                <br />
                पढ़ने लिखनेसे दूर हुई तब भी <strong className="text-lg text-bali">अयान है दक्खनी !</strong>
              </p>
