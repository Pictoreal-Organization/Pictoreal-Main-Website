          ...
          <div className="text-justify font-poppins text-[17px] text-firefly p-8 pl-[10px] pr-[10px] pt-[30px] pb-[30px]">
            <article className="p-2 lg:p-5">
              ...
              <p>
                ...
                <strong className="text-lg text-firefly">"और मियाँ, क्या चल रहा?"</strong>
              </p>
              ...
              <p>
                ...
                <strong className="text-lg text-firefly">हाओ</strong> क्या चीज़ होती है ।
                <br />
                टीचर ने दूसरे शख्स से पूछा ।
                <br />
                फिरसे जवाब मिला - <strong className="text-lg text-firefly">हाओ!</strong>
                <br />
                जब टीचर ने एक और बंदे से पूछा तो उसने कुछ अलग जवाब दिया |
                <br />
                उसने कहा - <strong className="text-lg text-firefly">जी हाँ!</strong>
                <br />
                <br />
                ...
                <strong className="text-lg text-firefly">हम रोज़ इस्तेमाल करते है</strong> और
              ...
              <p>
                ...
                <p className="text-lg text-firefly">
                  ...
                  <strong className="text-lg text-firefly">लिखी जाती थी !</strong> बहमनी
                  साम्राज्य के दौर में लगभग{" "}
                  <strong className="text-lg text-firefly">सन १५८०</strong>, या उससे भी पहले
                  ! दक्खनी बहमनी साम्राज्य की अधिकारिक भाषा हुआ करती थी । मुझे
                  यह भी पता चला कि{" "}
                  <strong className="text-lg text-firefly">हैदराबाद के नवाब</strong> मोहम्मद
              ...
              <p>
                ...
                बताना चाहता हूँ{" "}
                <strong className="text-lg text-firefly">'बैगन का मसला' !</strong> बैगन आपके
                लिए सिर्फ़ एक सब्ज़ी होगी, पर मुझ जैसे कई लोगों के लिए बैगन एक{" "}
                <strong className="text-lg text-firefly">सब्ज़ी से कहीं बढ़कर है !</strong>{" "}
                ...
                <strong className="text-lg text-firefly">विशेषण</strong> बन जाती है । बैगन
                ज़्यादातर एक <strong className="text-lg text-firefly">स्लैंग शब्द</strong>{" "}
                जैसे या फिर कोई{" "}
                <strong className="text-lg text-firefly">ख़राब या गलत हुई चीज़</strong> को
              ...
              <br></br>
              <p>
                <strong className="text-lg text-firefly">दक्खनी और मराठी</strong> का रिश्ता
                ...
                इन दोनों भाषाओं के{" "}
                <strong className="text-lg text-firefly">‘फ़ोनेटिक पैटर्न’</strong> में भी कई
                समानताएँ है, जिसके कारण इन भाषाओं पर{" "}
                <strong className="text-lg text-firefly">‘द्रविड़ियन इन्फ्लुएंस’</strong>{" "}
                देखने को मिलता है ।
              </p>
              <br />
              <p>
                ...
                <strong className="text-lg text-firefly">‘दरवाजा’</strong> (दरवाज़ा) और{" "}
                <strong className="text-lg text-firefly">‘महमान’</strong> (मेहमान) शामिल है ।
                इसके अतिरिक्त, दोनों भाषाओं में रोज-मर्रा की चीजों के लिए समान
                शब्द है : <strong className="text-lg text-firefly">‘किताब’</strong> (पुस्तक)
                दक्खनी और उर्दू में है, जब कि कन्नड़ में इसे{" "}
                <strong className="text-lg text-firefly">‘पुस्तका’</strong> कहा जाता है ।
                दखनी में <strong className="text-lg text-firefly">‘रोटी’</strong>, उर्दू में
                भी ‘रोटी’ ही है, जबकि कन्नड़ में इसे{" "}
                <strong className="text-lg text-firefly">‘रोट्टी’</strong> कहा जाता है ।
              ...
              <p className="mt-6">
                ...
                छोड़ो कल की बातें, कल कि बाते <strong className="text-lg text-firefly">बैगन</strong> की,
                <br />
                पढ़ने लिखनेसे दूर हुई तब भी <strong className="text-lg text-firefly">अयान है दक्खनी !</strong>
              </p>
