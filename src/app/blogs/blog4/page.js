    ...
    <>
      <div className="flex flex-col p-2 md:p-10 pt-10">
        <div className="relative bg-[#D2B49A] w-full md:w-4/5 max-w-[1200px] py-10 md:p-5 border-[10px] border-[#3A0622] mx-auto">
          <div className="font-raleway px-2 font-bold pt-10 text-2xl md:text-5xl text-[#561A34] text-center">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="font-poppins text-[20px] text-[#44449F] md:pl-8 pt-8">
              <span className="text-black">Author: </span>Ayan Pathan
            </div>
          </div>
          ...
          <div className="text-justify font-poppins text-[17px] text-black p-8 pl-[10px] pr-[10px] pt-[30px] pb-[30px]">
            <article className="p-2 lg:p-5">
              ...
              <p>
                ...
                <strong className="text-lg">"और मियाँ, क्या चल रहा?"</strong>
              </p>
              ...
              <p>
                ...
                आदमी ने जवाब दिया -
                <br />
                <strong className="text-lg">"हाओ!"</strong>
                <br />
                टीचर को समझ न आया कि यह{" "}
                <strong className="text-lg">"हाओ"</strong> क्या चीज़ होती है ।
                <br />
                टीचर ने दूसरे शख्स से पूछा ।
                <br />
                फिरसे जवाब मिला - <strong className="text-lg">"हाओ!"</strong>
                <br />
                जब टीचर ने एक और बंदे से पूछा तो उसने कुछ अलग जवाब दिया |
                <br />
                उसने कहा - <strong className="text-lg">"जी हाँ!"</strong>
                <br />
                <br />
                ...
                <strong className="text-lg">हम रोज़ इस्तेमाल करते है</strong> और
              ...
              <p>
                ...
                <p className="text-lg">
                  ...
                  <strong className="text-lg">सन १५८०</strong>, या उससे भी पहले
                  ! दक्खनी बहमनी साम्राज्य की अधिकारिक भाषा हुआ करती थी । मुझे
                  यह भी पता चला कि{" "}
                  <strong className="text-lg">हैदराबाद के नवाब</strong> मोहम्मद
              ...
              <p>
                ...
                बताना चाहता हूँ{" "}
                <strong className="text-lg">'बैगन का मसला' !</strong> बैगन आपके
                लिए सिर्फ़ एक सब्ज़ी होगी, पर मुझ जैसे कई लोगों के लिए बैगन एक{" "}
                <strong className="text-lg">सब्ज़ी से कहीं बढ़कर है !</strong>{" "}
                ...
                <strong className="text-lg">विशेषण</strong> बन जाती है । बैगन
                ज़्यादातर एक <strong className="text-lg">स्लैंग शब्द</strong>{" "}
                जैसे या फिर कोई{" "}
                <strong className="text-lg">ख़राब या गलत हुई चीज़</strong> को
                दर्शाने के लिए इस्तेमाल किया जाता है । मै आपको एक चित्र के सहारे
                समझाता हूँ ।
              </p>
              {/* </div> */}

              <div className="flex justify-center items-center my-4 border-[5px] border-[#3A0622] md:w-5/12 mx-auto">
                  <Image
              ...
              <p>
                ...
                इन दोनों भाषाओं के{" "}
                <strong className="text-lg">‘फ़ोनेटिक पैटर्न’</strong> में भी कई
                समानताएँ है, जिसके कारण इन भाषाओं पर{" "}
                <strong className="text-lg">‘द्रविड़ियन इन्फ्लुएंस’</strong>{" "}
                देखने को मिलता है ।
              </p>
              <br />
              <p>
                ...
                <strong className="text-lg">‘दरवाजा’</strong> (दरवाज़ा) और{" "}
                <strong className="text-lg">‘महमान’</strong> (मेहमान) शामिल है ।
                इसके अतिरिक्त, दोनों भाषाओं में रोज-मर्रा की चीजों के लिए समान
                शब्द है : <strong className="text-lg">‘किताब’</strong> (पुस्तक)
                दक्खनी और उर्दू में है, जब कि कन्नड़ में इसे{" "}
                <strong className="text-lg">‘पुस्तका’</strong> कहा जाता है ।
                दखनी में <strong className="text-lg">‘रोटी’</strong>, उर्दू में
                भी ‘रोटी’ ही है, जबकि कन्नड़ में इसे{" "}
                <strong className="text-lg">‘रोट्टी’</strong> कहा जाता है ।
              ...
              <p className="mt-6">
                ...
                छोड़ो कल की बातें, कल कि बाते <strong className="text-lg">बैगन</strong> की,
                <br />
                पढ़ने लिखनेसे दूर हुई तब भी <strong className="text-lg">अयान है दक्खनी !</strong>
              </p>
