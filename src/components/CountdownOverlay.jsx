...
//   const launchDate = new Date("2025-09-20T20:59:00").getTime();
...
//     <div className={`flex flex-col items-center mx-2 md:mx-6 transform transition-all duration-700 ease-out ${ // ✅ Reduced horizontal margin for mobile
//       isTransitioning ? 'scale-95 opacity-0' : 'scale-100 opacity-100'
//     }`}>
//       {/* ✅ Adjusted timer box size for mobile */}
...
//         {/* ✅ Adjusted timer font size for mobile */}
...
//         <div className="relative mt-12 md:mt-16" style={{ perspective: '1000px' }}> {/* ✅ Reduced top margin for mobile */}
...
//                 src="/navbar_logo.png"
//                 alt="Navbar Logo"
//                 className="h-20 md:h-32 object-contain" // ✅ Adjusted navbar logo size for mobile
//               />
//               {/* ✅ Adjusted text size for mobile */}
//               <p className="text-base md:text-xl font-body text-[#001730]/80 text-center whitespace-nowrap">
...
//           </h1>
//           {/* ✅ Adjusted text size for mobile */}
//           <p className="text-base md:text-xl font-body font-medium text-[#001730]/80 text-center">
//             Where thoughts, colours, and words prevail!
//           </p>
//         </div>
...
export default function CountdownOverlay() {
  const launchDate = new Date("2025-09-22T14:30:00").getTime();
  const getTimeLeft = () => launchDate - Date.now();
