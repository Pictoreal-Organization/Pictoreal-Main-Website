...
const Navbar = () => {
  ...
  const [dropdownOpen, setDropdownOpen] = useState(false); // Magazines dropdown state
        ...
        >
          <ul className="text-base text-firefly lg:flex lg:justify-between">
            ...
            >
              ...
              <ul
                ref={dropdownRef}
                className={`absolute left-0 mt-2 w-32 text-firefly bg-mist rounded-lg shadow-lg z-10 transform transition-all duration-500 ease-in-out ${dropdownOpen
