...
const Footer = () => {
  return (
    <footer id="footer" className="bg-[#111C33] text-gray-300 font-body scroll-mt-20">
      <div className="container mx-auto py-12 px-8">
        <div className="flex flex-col lg:flex-row justify-between gap-10">

          {/* Left Section: Address and Map */}
          <div className="w-full lg:w-5/12">
            <h3 className="text-xl font-body text-white mb-4">PICTOREAL</h3>
          ...
          <div className="w-full lg:w-2/12">
            <h3 className="text-xl font-body text-white mb-4">Useful Links</h3>
          ...
          <div className="w-full lg:w-3/12">
            <h3 className="text-xl font-body text-white mb-4">Socials</h3>
            <p className="mb-2">
      ...
      <div className="text-center border-t border-gray-800 bg-[#112b45] mt-2 p-2">
        ...
        <a href="/developers" className="hover:text-[#b3dfff] font-body transition-colors hover:underline">
          Pictoreal Tech Team
        </a>
      </div>
    </footer>
