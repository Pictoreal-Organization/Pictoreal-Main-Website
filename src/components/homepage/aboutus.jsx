          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left relative w-full">
            ...
            <div className="flex flex-col items-center space-y-8 mt-3 lg:mt-20 w-full">
              ...
              <p className="text-sm text-gray-700 font-body max-w-md text-center">
                We’re Pictoreal, PICT’s oldest non-technical club and the team behind the annual college magazine. From ideas to design and stories to visuals, everything is created by students, for students, guided by the motto:
              </p>

              <p className="text-base italic font-bold text-gray-800 font-body max-w-md text-center px-4">
